...
import type { IPhotoImage } from '@/lib/types';
import {
  processSecureImage,
...
export { validateUploadedImage, validateByTier, getTierValidationOptions } from '@/lib/upload/validator';

/**
 * @deprecated Use validateUploadedImage from '@/lib/upload/validator' instead
