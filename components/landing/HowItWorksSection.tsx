            ...
            <div key={item.step} className="relative">
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                >
                  ...
                  <div className="absolute -right-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-white text-xs font-bold text-gray-900 shadow-md ring-2 ring-gray-100">
                    {item.step}
                  </div>
                </div>
                <h3 className="mt-6 text-xl font-semibold text-gray-900">{item.title}</h3>
                <p className="mt-3 max-w-xs text-[15px] leading-relaxed text-gray-500">
                  {item.desc}
                </p>
              </div>
            </div>
